...
def table_exists(name=None, con=None, flavor='sqlite',silent=True):
    if flavor == 'sqlite':
...
def write_frame(frame, name=None, con=None, flavor='sqlite', if_exists='fail',silent=True):
    """
