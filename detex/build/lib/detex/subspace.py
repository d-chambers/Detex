...
class SSCluster(object):
    ...
    def simMatrix(self,savename=False,returnMat=False,**kwargs):
        """
        ...
        -------
        savename : str
            A path used by plt.savefig to save the current figure. The extension is necesary for specifying format. See plt.savefig for details
        returnMat : boolean 
