...
If you are looking for more in-depth information about detex checkout the [advanced tutorial](advanced.md).
...
The CONTRIBUTOR and MTYPE fields are not required but can be useful for record keeping. Additionally, any extra fields can be added in order to better keep track of the events. 
